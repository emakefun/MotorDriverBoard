...
void loop()
{
    StepperMotor_1->step(200, 1); //电机1正转1圈 200步
    StepperMotor_1->release();
    StepperMotor_2->step(200, 1); //电机2正转1圈 200步
    StepperMotor_2->release();

    delay(1000);
    StepperMotor_1->step(200, 2); //电机1反转1圈 200步
    StepperMotor_1->release();
    StepperMotor_2->step(200, 2); //电机2反转1圈 200步
    StepperMotor_2->release();
    delay(1000);
}
