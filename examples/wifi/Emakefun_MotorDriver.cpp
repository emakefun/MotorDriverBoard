...
void Emakefun_EncoderMotor::init(FuncPtr encoder_fun) {
  ...
  if (encodernum == 0) {
#if ARDUINO > 10609
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&EncoderCallback1), RISING);
#else
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&Emakefun_EncoderMotor::EncoderCallback1), RISING);
#endif
  } else if (encodernum == 1) {
#if ARDUINO > 10609
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&EncoderCallback2), RISING);
#else
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&Emakefun_EncoderMotor::EncoderCallback2), RISING);
#endif
  } else if (encodernum == 2) {

#if ARDUINO > 10609
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&EncoderCallback3), RISING);
#else
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&Emakefun_EncoderMotor::EncoderCallback3), RISING);
#endif
  } else if (encodernum == 3) {
#if ARDUINO > 10609
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&EncoderCallback4), RISING);
#else
    attachPinChangeInterrupt(ENCODER1pin, *(FuncPtr )(&Emakefun_EncoderMotor::EncoderCallback4), RISING);
#endif
  }
