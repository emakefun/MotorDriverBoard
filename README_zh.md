...
##### A ：如果用Uno的DC头供电，最大能够驱动12V 3A的电机，如果是驱动板上的接线柱供电，可以最大驱动36V 3A的电机。我们供电必须要先知道电机的额定电压是多少，比如额点电压是6V-1A，那么我们供电就只能是8.4V锂电池供电（如果用用12V供电有概率会烧电机），如果额定电压是12V的电机，那么供电也要用三节锂电池11.1V的电池。总之电机额定电压和电流不要和实际供电电源相差很大，否则驱动不了电机。
