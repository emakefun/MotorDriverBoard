...
##### A ：如果DC头供电，最大能够驱动12V 3A的电机，如果接线柱供电可以驱动36V 3A的电机。我们供电必须要和先知道电机的额定电压是多少，比如额点电压是6V 1A，那么我们供电就只能是8.4V锂电池供电（如果用12V有概率可能烧电机），如果是12V的电机，那么我们供电也要用三节锂电池11.1V的电池。总之电机额定电压和电流不要和实际供电相差很大。那么驱动板将带动不了电机。
